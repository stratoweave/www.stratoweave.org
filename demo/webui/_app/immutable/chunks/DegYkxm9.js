...
</rfs>`,re=JSON.stringify({"rfs:rfs":{device:[{name:`AMS-CORE-1`,service:[`base-router`,`backbone-interface ethernet-1/1`,`backbone-interface ethernet-1/2`,`vrf acme-65501`,`vrf globex-65502`]},{name:`FRA-CORE-1`,service:[`base-router`,`backbone-interface ethernet-1/1`,`backbone-interface ethernet-1/2`,`backbone-interface ethernet-1/3`,`vrf acme-65501`]},{name:`STO-CORE-1`,service:[`base-router`,`backbone-interface ethernet-1/1`,`backbone-interface ethernet-1/2`,`backbone-interface ethernet-1/3`,`vrf acme-65501`,`vrf globex-65502`]},{name:`LJU-CORE-1`,service:[`base-router`,`backbone-interface ethernet-1/1`,`backbone-interface ethernet-1/2`,`vrf acme-65501`]}]}},null,2),ie=`rfs {
...
}`;function b(e,t,n){if(e===0)return t===`json`?JSON.stringify({...n.netinfra,...n.l3vpn},null,2):t===`adata`?y:ae;if(e===1)return t===`json`?te:t===`adata`?ne:ee;if(e===2)return t===`json`?re:t===`adata`?ie:v;if(t===`json`){let e={};for(let t of n.routers)e[t.name]=a(t.name,t.id);return JSON.stringify({"device-config:devices":e},null,2)}return t===`adata`?n.routers.map(e=>`device ${e.name} {\n${o(e.name,e.id).split(`
`).map(e=>`    ${e}`).join(`
`)}\n}`).join(`
`):`<devices>\n${n.routers.map(e=>`  <device>\n    <name>${e.name}</name>\n${i(e.name,e.id).split(`
`).map(e=>`    ${e}`).join(`
`)}\n  </device>`).join(`
`)}\n</devices>`}var oe=[{name:`srl_nokia-interfaces`,namespace:`urn:nokia.com:srlinux:chassis:interfaces`,revision:`2025-03-31`},{name:`srl_nokia-network-instance`,namespace:`urn:nokia.com:srlinux:net-inst:network-instance`,revision:`2025-03-31`},{name:`srl_nokia-bgp`,namespace:`urn:nokia.com:srlinux:bgp:bgp`,revision:`2025-03-31`},{name:`srl_nokia-routing-policy`,namespace:`urn:nokia.com:srlinux:pol:routing-policy`,revision:`2025-03-31`},{name:`srl_nokia-system`,namespace:`urn:nokia.com:srlinux:general:system`,revision:`2025-03-31`},{name:`ietf-netconf`,namespace:`urn:ietf:params:xml:ns:netconf:base:1.0`,revision:`2011-06-01`,features:[`candidate`,`validate`,`startup`]},{name:`ietf-netconf-monitoring`,namespace:`urn:ietf:params:xml:ns:yang:ietf-netconf-monitoring`,revision:`2010-10-04`}];function x(e,t){return{name:e,type:`NokiaSRLinux_25_3_2`,username:`admin`,addresses:[{name:`mgmt`,address:`172.20.20.${10+t}`,port:830}],feature_flags:{confirmed_commit:!0,validate:!0,startup:!1},modules:oe}}var se=[{"vpn-id":`acme-65501`,"customer-name":`CUSTOMER-1`},{"vpn-id":`globex-65502`,"customer-name":`GLOBEX`}];function S(e,t,n,r,i,a){return{"site-id":e,management:{type:`customer-managed`},locations:{location:[{"location-id":`MAIN`}]},"site-network-accesses":{"site-network-access":[{"site-network-access-id":t,"location-reference":`MAIN`,service:{"svc-input-bandwidth":`1000000000`,"svc-output-bandwidth":`1000000000`,"svc-mtu":9e3},"vpn-attachment":{"vpn-id":i},"ip-connection":{ipv4:{"address-allocation-type":`static-address`,addresses:{"provider-address":`${r}.1`,"customer-address":`${r}.2`,"prefix-length":30}}},bearer:{"bearer-reference":n},"routing-protocols":{"routing-protocol":[{type:`bgp`,bgp:{"autonomous-system":a,"address-family":[`ipv4`],"sorespo-ietf-l3vpn-svc:authentication-key":i}}]}}]}}}var C=[S(`SITE-1`,`SNA-1-1`,`AMS-CORE-1,ethernet-1/3.100`,`10.201.1`,`acme-65501`,65501),S(`SITE-2`,`SNA-2-1`,`FRA-CORE-1,ethernet-1/4.100`,`10.202.1`,`acme-65501`,65501),S(`SITE-3`,`SNA-3-1`,`STO-CORE-1,ethernet-1/4.100`,`10.203.1`,`acme-65501`,65501),S(`SITE-4`,`SNA-4-1`,`LJU-CORE-1,ethernet-1/3.100`,`10.204.1`,`acme-65501`,65501),S(`SITE-5`,`SNA-5-1`,`AMS-CORE-1,ethernet-1/5.200`,`10.205.1`,`globex-65502`,65502),S(`SITE-6`,`SNA-6-1`,`STO-CORE-1,ethernet-1/5.200`,`10.206.1`,`globex-65502`,65502)],w={"ibgp-authentication-key":`ibgp-authentication-key`},T=[{name:`AMS-CORE-1`,id:1,type:`NokiaSRLinux_25_3_2`,role:`edge`,asn:65001,"approval-required":!0},{name:`FRA-CORE-1`,id:2,type:`NokiaSRLinux_25_3_2`,role:`edge`,asn:65001},{name:`STO-CORE-1`,id:3,type:`NokiaSRLinux_25_3_2`,role:`edge`,asn:65001},{name:`LJU-CORE-1`,id:4,type:`NokiaSRLinux_25_3_2`,role:`edge`,asn:65001}],E=[{"left-router":`AMS-CORE-1`,"left-interface":`ethernet-1/1`,"right-router":`FRA-CORE-1`,"right-interface":`ethernet-1/1`,"monitor-traffic":!0,state:{"left-pps":18420,"right-pps":17155,"link-status":`up`}},{"left-router":`AMS-CORE-1`,"left-interface":`ethernet-1/2`,"right-router":`STO-CORE-1`,"right-interface":`ethernet-1/1`,"monitor-traffic":!0,state:{"left-pps":9640,"right-pps":10480,"link-status":`up`}},{"left-router":`FRA-CORE-1`,"left-interface":`ethernet-1/2`,"right-router":`STO-CORE-1`,"right-interface":`ethernet-1/2`},{"left-router":`FRA-CORE-1`,"left-interface":`ethernet-1/3`,"right-router":`LJU-CORE-1`,"right-interface":`ethernet-1/1`},{"left-router":`STO-CORE-1`,"left-interface":`ethernet-1/3`,"right-router":`LJU-CORE-1`,"right-interface":`ethernet-1/2`,"monitor-traffic":!0,state:{"left-pps":0,"right-pps":0,"link-status":`down`}}],D={"AMS-CORE-1":[{diffXml:u(`acme-65501`,`ethernet-1/3.100`,`10.201.1.1`,30,65501)},{diffXml:f(`ethernet-1/1`,`backbone to FRA-CORE-1 ethernet-1/1`)}],"LJU-CORE-1":[{diffXml:p(`ethernet-1/4`,`300`)}]},O=3600,k=24*O,ce={"AMS-CORE-1":[{event:`sent`,ageSeconds:2*O,conf_diff:u(`globex-65502`,`ethernet-1/5.200`,`10.205.1.1`,30,65502)},{event:`sent`,ageSeconds:93600,conf_diff:f(`ethernet-1/2`,`backbone to STO-CORE-1 ethernet-1/1`)},{event:`sent`,ageSeconds:3*k}],"FRA-CORE-1":[{event:`failed`,ageSeconds:5*O,conf_diff:f(`ethernet-1/9`,`lab port (interface does not exist)`)},{event:`sent`,ageSeconds:108e3,conf_diff:u(`acme-65501`,`ethernet-1/4.100`,`10.202.1.1`,30,65501)}],"STO-CORE-1":[{event:`sent`,ageSeconds:8*O,conf_diff:u(`globex-65502`,`ethernet-1/5.200`,`10.206.1.1`,30,65502)},{event:`sent`,ageSeconds:2*k}],"LJU-CORE-1":[{event:`sent`,ageSeconds:5400,conf_diff:u(`acme-65501`,`ethernet-1/3.100`,`10.204.1.1`,30,65501)},{event:`sent`,ageSeconds:144e3}]},A=null;function le(){let e={globalSettings:structuredClone(w),routers:structuredClone(T),backboneLinks:structuredClone(E),vpnServices:structuredClone(se),sites:structuredClone(C),devices:{},counters:{queueId:240,tid:195}},t=Math.floor(Date.now()/1e3);for(let n of T){let r=String(n.name);e.devices[r]={staticInfo:x(r,n.id??0),hasRunningConfig:!0,hasTargetConfig:!0,queue:[],log:(ce[r]??[]).map(e=>({event:e.event,timestamp:String(t-e.ageSeconds),...e.conf_diff?{conf_diff:e.conf_diff}:{}}))}}for(let[t,n]of Object.entries(D)){let r=e.devices[t];if(r)for(let t of n)r.queue.push(M(e,t.diffXml))}return e}function j(){return A||=le(),A}function ue(){A=null}function M(e,t){let n=String(++e.counters.queueId),r=String(++e.counters.tid);return{queueId:n,tid:r,deviceTxid:`d-${r}`,diffXml:t}}function N(e,t){let n=j().devices[e];n&&n.queue.push(M(j(),t))}function P(e,t,n){let r=j().devices[e];r&&r.log.unshift({event:t,timestamp:String(Math.floor(Date.now()/1e3)),...n?{conf_diff:n}:{}})}function F(e,t,n){let r=j();r.devices[e]||(r.devices[e]={staticInfo:x(e,t),hasRunningConfig:!1,hasTargetConfig:!0,queue:[M(r,n)],log:[]})}function I(e){delete j().devices[e]}var L=90;function R(){return new Promise(e=>setTimeout(e,L+Math.random()*60))}function z(e,t=200){return new Response(JSON.stringify(e),{status:t,headers:{"content-type":`application/yang-data+json`}})}function B(e,t=`text/plain`){return new Response(e,{status:200,headers:{"content-type":t}})}function V(e=204){return new Response(null,{status:e})}function H(e){return z({"ietf-restconf:errors":{error:[{"error-type":`application`,"error-tag":`invalid-value`,"error-message":e}]}},404)}function U(e){return z({message:e},404)}function W(e,t){let n=t?e.backboneLinks.map(e=>de(e)):e.backboneLinks;return{"global-settings":e.globalSettings,router:e.routers,"backbone-link":n}}function de(e){if(!e[`monitor-traffic`]||!e.state||e.state[`link-status`]!==`up`)return e;let t=e=>{let t=Number(e??0);return Math.max(0,Math.round(t*(.9+Math.random()*.2)))};return{...e,state:{...e.state,"left-pps":t(e.state[`left-pps`]),"right-pps":t(e.state[`right-pps`])}}}function fe(e){return{"vpn-services":{"vpn-service":e.vpnServices},sites:{site:e.sites}}}function G(e,t){return e.routers.find(e=>e.name===t)?.id??9}function pe(e){return Object.keys(e.devices).map(t=>({name:t,id:G(e,t)}))}function K(e){let t=e?.[`site-network-accesses`]?.[`site-network-access`]?.[0],n=String(t?.bearer?.[`bearer-reference`]??``);if(!n)return null;let[r=``,i=``]=n.split(`,`).map(e=>e.trim()),a=t?.[`ip-connection`]?.ipv4?.addresses,o=t?.[`routing-protocols`]?.[`routing-protocol`]?.[0]?.bgp;return{router:r,iface:i||`ethernet-1/9.100`,vpnId:String(t?.[`vpn-attachment`]?.[`vpn-id`]??`l3vpn`),providerAddress:String(a?.[`provider-address`]??`10.209.1.1`),prefixLength:Number(a?.[`prefix-length`]??30),asn:Number(o?.[`autonomous-system`]??65500)}}function q(e){let t=K(e);t&&N(t.router,u(t.vpnId,t.iface,t.providerAddress,t.prefixLength,t.asn))}function me(e){let t=K(e);t&&N(t.router,d(t.vpnId,t.iface))}function J(e){if(typeof e?.body!=`string`||!e.body)return null;try{return JSON.parse(e.body)}catch{return null}}function Y(e,t){if(!e||typeof e!=`object`)return null;let n=e[t];if(Array.isArray(n))return n[0]??null;if(n&&typeof n==`object`)return n;let r=Object.values(e)[0];return Array.isArray(r)?r[0]??null:typeof r==`object`?r:null}function X(e,t){return String(e[`left-router`]??``)===t[0]&&String(e[`left-interface`]??``)===t[1]&&String(e[`right-router`]??``)===t[2]&&String(e[`right-interface`]??``)===t[3]}function Z(e){let t=j(),n=String(e.name??``);if(!n)return;let r=t.routers.findIndex(e=>e.name===n),i=r===-1,a=Number(e.id)||(i?Math.max(0,...t.routers.map(e=>e.id??0))+1:t.routers[r].id??9),o={...e,name:n,id:a};i?t.routers.push(o):t.routers[r]=o;let s=Number(e.asn)||65001;t.devices[n]?N(n,g(n,a,s)):F(n,a,g(n,a,s))}function he(e){let t=j();t.routers=t.routers.filter(t=>t.name!==e),t.backboneLinks=t.backboneLinks.filter(t=>t[`left-router`]!==e&&t[`right-router`]!==e),I(e)}function Q(e,t){let n=j(),r=n.backboneLinks.findIndex(e=>X(e,t));r===-1?n.backboneLinks.push(e):n.backboneLinks[r]={...n.backboneLinks[r],...e};let i=String(e[`left-router`]??t[0]),a=String(e[`right-router`]??t[2]);N(i,m(String(e[`left-interface`]??t[1]),a,String(e[`right-interface`]??t[3]))),N(a,m(String(e[`right-interface`]??t[3]),i,String(e[`left-interface`]??t[1])))}function ge(e){let t=j();t.backboneLinks=t.backboneLinks.filter(t=>!X(t,e)),N(e[0],p(e[1].split(`.`)[0],`0`)),N(e[2],p(e[3].split(`.`)[0],`0`))}function $(e,t,n){let r=String(n[t]??``),i=e.findIndex(e=>String(e[t]??``)===r);i===-1?e.push(n):e[i]=n}async function _e(e,t,n,r){let i=j();if(e.length===1&&e[0]===`data`)return t===`PATCH`?(ve(n),V(200)):H(`unsupported ${t} on /data`);let[a,o,...s]=e;if(a!==`data`)return H(`unknown path /${e.join(`/`)}`);if(o===`netinfra:netinfra`){if(s.length===0)return t===`GET`?z({"netinfra:netinfra":W(i,!0)}):H(`unsupported ${t} on netinfra:netinfra`);let[r]=s;if(r===`global-settings`){if(t===`GET`)return z({"netinfra:global-settings":i.globalSettings});if(t===`PUT`){i.globalSettings=Y(J(n),`netinfra:global-settings`)??{};for(let e of Object.keys(i.devices))N(e,h());return V()}return H(`unsupported ${t} on global-settings`)}if(r.startsWith(`router=`)){let e=decodeURIComponent(r.slice(7)),a=i.routers.find(t=>t.name===e);if(t===`GET`)return a?z({"netinfra:router":[a]}):H(`no router ${e}`);if(t===`PUT`){let t=Y(J(n),`netinfra:router`);return t&&Z({...t,name:t.name??e}),V()}if(t===`DELETE`)return a?(he(e),V()):H(`no router ${e}`)}if(r.startsWith(`backbone-link=`)){let e=r.slice(14).split(`,`).map(e=>decodeURIComponent(e).trim()),a=i.backboneLinks.find(t=>X(t,e));if(t===`GET`)return a?z({"netinfra:backbone-link":[a]}):H(`no backbone-link ${e.join(`,`)}`);if(t===`PUT`){let t=Y(J(n),`netinfra:backbone-link`);return t&&Q(t,e),V()}if(t===`DELETE`)return a?(ge(e),V()):H(`no backbone-link ${e.join(`,`)}`)}return H(`unknown netinfra path /${e.join(`/`)}`)}if(o===`ietf-l3vpn-svc:l3vpn-svc`){let[r,a]=s;if(r===`sites`){if(!a)return t===`GET`?z({"ietf-l3vpn-svc:sites":{site:i.sites}}):H(`unsupported ${t} on sites`);if(a.startsWith(`site=`)){let e=decodeURIComponent(a.slice(5)),r=i.sites.findIndex(t=>String(t[`site-id`])===e);if(t===`GET`)return r===-1?H(`no site ${e}`):z({"ietf-l3vpn-svc:site":[i.sites[r]]});if(t===`PUT`){let t=Y(J(n),`ietf-l3vpn-svc:site`);return t&&($(i.sites,`site-id`,{...t,"site-id":t[`site-id`]??e}),q(t)),V()}if(t===`DELETE`)return r===-1?H(`no site ${e}`):(me(i.sites[r]),i.sites.splice(r,1),V())}}if(r===`vpn-services`){if(!a)return t===`GET`?z({"ietf-l3vpn-svc:vpn-services":{"vpn-service":i.vpnServices}}):H(`unsupported ${t} on vpn-services`);if(a.startsWith(`vpn-service=`)){let e=decodeURIComponent(a.slice(12)),r=i.vpnServices.findIndex(t=>String(t[`vpn-id`])===e);if(t===`GET`)return r===-1?H(`no vpn-service ${e}`):z({"ietf-l3vpn-svc:vpn-service":[i.vpnServices[r]]});if(t===`PUT`){let t=Y(J(n),`ietf-l3vpn-svc:vpn-service`);return t&&$(i.vpnServices,`vpn-id`,{...t,"vpn-id":t[`vpn-id`]??e}),V()}if(t===`DELETE`)return r===-1?H(`no vpn-service ${e}`):(i.vpnServices.splice(r,1),V())}}return H(`unknown l3vpn path /${e.join(`/`)}`)}return H(`unknown path /${e.join(`/`)}`)}function ve(e){let t=j(),n=J(e),r=new Set;if(n&&typeof n==`object`){let e=n[`ietf-l3vpn-svc:l3vpn-svc`];for(let n of e?.[`vpn-services`]?.[`vpn-service`]??[])$(t.vpnServices,`vpn-id`,n);for(let n of e?.sites?.site??[]){$(t.sites,`site-id`,n);let e=K(n);e&&t.devices[e.router]&&(q(n),r.add(e.router))}let i=n[`netinfra:netinfra`];for(let e of i?.router??[])Z(e),r.add(String(e.name??``));for(let e of i?.[`backbone-link`]??[]){let t=[String(e[`left-router`]??``),String(e[`left-interface`]??``),String(e[`right-router`]??``),String(e[`right-interface`]??``)];Q(e,t),r.add(t[0]),r.add(t[2])}if(i?.[`global-settings`]){t.globalSettings=i[`global-settings`];for(let e of Object.keys(t.devices))N(e,h()),r.add(e)}}if(r.size===0)for(let e of Object.keys(t.devices))N(e,_())}function ye(e,t){let n=e.devices[t];if(!n)return null;let r=e.routers.find(e=>e.name===t);return{...n.staticInfo,approval_required:!!(r?.[`approval-required`]??!1),has_running_config:n.hasRunningConfig,has_target_config:n.hasTargetConfig,queue_length:n.queue.length,pending_approvals:n.queue.length}}function be(e,t,n,r){let l=e.devices[t];if(!l)return``;let u=G(e,t),d=r===`target`&&l.queue.length>0;if(r===`running`&&!l.hasRunningConfig)return n===`json`?`{}`:`<!-- no running configuration: device has not been synchronized yet -->`;if(n===`json`){let e=a(t,u);return d&&e[`srl_nokia-interfaces:interface`].push(c()),JSON.stringify(e,null,2)}if(n===`adata`)return o(t,u)+(d?`
interface ethernet-1/6 { description: "pending change awaiting approval" }`:``);let f=i(t,u);return d?f.replace(`</config>`,`${s()}\n</config>`):f}async function xe(e,t,n,r,i){let a=j();if(e[0]===`device`&&e.length===1)return z({devices:Object.keys(a.devices)});if(e[0]===`config-queue`&&e.length===1)return z({devices:Object.entries(a.devices).filter(([,e])=>e.queue.length>0).map(([e,t])=>({device_id:e,items:t.queue.map(e=>({queue_id:e.queueId,device_txid:e.deviceTxid,approved:null}))}))});if(e[0]===`layer`&&e.length===2)return B(b(Number(e[1]),i.includes(`acton-adata`)?`adata`:i.includes(`json`)?`json`:`xml`,{netinfra:{"netinfra:netinfra":W(a,!1)},l3vpn:{"ietf-l3vpn-svc:l3vpn-svc":fe(a)},routers:pe(a)}),i||`application/yang-data+xml`);if(e[0]===`device`&&e.length>=3){let i=decodeURIComponent(e[1]),o=a.devices[i];if(!o)return U(`unknown device ${i}`);let s=e[2],c=r.get(`format`)??`json`;if(s===`info`)return z(ye(a,i));if(s===`resync`)return o.hasRunningConfig=!0,P(i,`resync`),z({});if(s===`q`&&e.length===3)return z(Object.fromEntries(o.queue.map(e=>[e.queueId,{tid:e.tid}])));if(s===`q`&&e.length>=4){let a=decodeURIComponent(e[3]),s=o.queue.find(e=>e.queueId===a);if(e[4]===`set_approval`){if(t!==`POST`)return U(`set_approval expects POST`);if(!s)return U(`no queue item ${a} on ${i}`);let e=!!J(n)?.approved;return o.queue=o.queue.filter(e=>e.queueId!==a),P(i,e?`sent`:`rejected`,s.diffXml),e&&(o.hasRunningConfig=!0),z({})}return s?z({tid:s.tid,device_txid:s.deviceTxid,config_diff:s.diffXml,format:r.get(`format`)??`xml`,approved:null}):U(`no queue item ${a} on ${i}`)}if(s===`running`||s===`target`)return B(be(a,i,c,s));if(s===`diff`)return B(o.queue.map(e=>e.diffXml).join(`
`)||`<!-- running and target configuration are in sync -->`);if(s===`log`)return z({log:o.log})}return U(`unknown API path /${e.join(`/`)}`)}function Se(){return(async(e,t)=>{let n=typeof e==`string`?e:e instanceof URL?e.href:e.url,r=new URL(n,`http://demo.invalid`),i=(t?.method??(e instanceof Request?e.method:`GET`)).toUpperCase(),a=new Headers(t?.headers).get(`accept`)??``;return await R(),r.pathname.startsWith(`/api/restconf/`)?_e(r.pathname.slice(14).split(`/`).filter(Boolean),i,t,r.searchParams):r.pathname.startsWith(`/api/`)?xe(r.pathname.slice(5).split(`/`).filter(Boolean),i,t,r.searchParams,a):U(`the demo only serves /api paths, got ${r.pathname}`)})}var Ce=Se();export{ue as n,Ce as t};